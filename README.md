...
Για block_size = 512 bytes, ενα data block χωράει 512 - 4/24 (24 ειναι το μέγεθος της κάθε εγγραφής) = 21 εγγραφές. Αν ο αριθμός των πόλεων ή αντίστοιχα των επιθέτων (ανάλογα ποιο ειναι το index_key) είναι περιορισμένος, ενώ ο αριθμός τον εγγραφών μεγαλώνει σε σημαντικό βαθμο, απο ενα σημείο και μετά το δευτερεύον ευρετήριο θα φτάνει το μέγιστο βάθος επειδή κάθε πόλη θα προορίζεται στον ίδιο κάδο με αποτέλεσμα να γεμίζει.
