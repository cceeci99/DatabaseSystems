...
typedef enum BF_ErrorCode {
  ...
  BF_INVALID_FILE_ERROR,         /* Ο αναγνωριστικός αριθμός αρχείου δεν αντιστοιχεί σε κάποιο ανοιχτό αρχείο */
 ...
 * περίπτωση που απλώς διαβάζουμε τα δεδομένα χωρίς να τα αλλάζουμε τότε
